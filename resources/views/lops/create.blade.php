    ...
    <section class="content" style="background-color:#dcedc8">
      ...
      <div class="col-md-12">
            ...
            <div class="card card-primary"  style="background-color:#e8f5e9">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('lops.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                 <div class="form-group">
                    <label for="exampleName">Mã lớp</label>
                    <input type="text" class="form-control" id="malop" placeholder="Mã lớp" name="malop" value="{{old('malop')}}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Tên lớp</label>
                    <input type="text" class="form-control" id="tenlop" placeholder="Tên lớp" name="tenlop" value="{{old('tenlop')}}">
                  </div>             
                <!-- /.card-body -->
